<script>
    ...
    var customizer = 
        ...
        '                            </ul>' +
        '                        </div>' +
        '                        <div class="body bg-light"><span class="badge badge-primary">Dubai</span></div>' +
        '                    </li>' +
        ...
        '                <ul class="layout-grid unlimited-color-layout"> <input id="ColorPicker1" type="color" value="#7366ff"' +
        '                        name="Background" /> <input id="ColorPicker2" type="color" value="#f73164" name="Background" />' +
        '                    <button type="button" class="color-apply-btn btn btn-primary color-apply-btn">Apply</button></ul>' +
        '                <h6>Light layout</h6>' +
    ...
    $(document).ready(function() {
        ...
        $(".customizer-color li").on('click', function() {
            ...
            $("#color").attr("href", "{{ env('APP_URL') }}/assets/css/" + color + ".css");
